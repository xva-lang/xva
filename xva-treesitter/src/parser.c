...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_negation_expression] = STATE(27),
    ...
    [sym__decimal_literal] = STATE(48),
    [sym_float_literal] = STATE(28),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [64] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_expression, 3, .production_id = 1),
  [66] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_not_expression, 2),
  [68] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_not_expression, 2),
  [70] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_float_literal, 4, .production_id = 3),
  [72] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_float_literal, 4, .production_id = 3),
  [74] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_boolean_literal, 1),
  [76] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_boolean_literal, 1),
  [78] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_float_literal, 3, .production_id = 2),
  [80] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_float_literal, 3, .production_id = 2),
  [82] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__item, 1),
  [84] = {.entry = {.count = 1, .reusable = true}}, SHIFT(44),
  [86] = {.entry = {.count = 1, .reusable = true}}, SHIFT(33),
  [88] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__item, 1),
  ...
  [102] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_integer_literal, 1),
  [104] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_integer_literal, 1),
  [106] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_literal, 3),
  [108] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_literal, 3),
  [110] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unary_expression, 1),
  [112] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_unary_expression, 1),
  [114] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_literal, 1),
  [116] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_literal, 1),
  [118] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_root_repeat1, 2),
  [120] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_root_repeat1, 2), SHIFT_REPEAT(32),
  [123] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_root_repeat1, 2), SHIFT_REPEAT(38),
  [126] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_root_repeat1, 2), SHIFT_REPEAT(4),
  [129] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_root_repeat1, 2), SHIFT_REPEAT(24),
  [132] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_root_repeat1, 2), SHIFT_REPEAT(28),
  [135] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_root_repeat1, 2), SHIFT_REPEAT(47),
  [138] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_root_repeat1, 2), SHIFT_REPEAT(8),
  [141] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 1),
  [143] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat1, 2), SHIFT_REPEAT(45),
